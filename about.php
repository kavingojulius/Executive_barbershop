        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col-xl-4 mb-3 mb-xl-0">
                    <h5 class="text-uppercase font-body mt-n1">EXPLORE <span class="text-theme">Our</span> Services</h5>
                    <p>Enter our premier barbershop and spa for precision haircuts, clean shaves, rejuvenating massages, and luxurious facials. Our expert team creates a sanctuary where every visit leaves you refreshed and confident.</p>
                </div>
                <div class="col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="row gx-60">
                        ...
                        <div class="col">
                            <h4 class="fw-medium fs-20 font-body mt-n1 mb-lg-3 pb-lg-1">Precision Grooming</h4>
                ...
                <div class="col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="row gx-60">
                        ...
                        <div class="col">
                            <h4 class="fw-medium fs-20 font-body mt-n1 mb-lg-3 pb-lg-1">Spa Indulgences</h4>
                            <div class="list-style1">
                                <ul class="list-unstyled">
                                    <li>Soothing Massages</li>
                                    <li>Revitalizing Facials</li>
                                    <li>Manicures & Pedicures</li>
                                    <li>Body Treatments</li>
                                    <li>Tranquil Ambiance</li>
                                    <li>Happy Guests</li>
                                </ul>
                            </div>
                        </div>
